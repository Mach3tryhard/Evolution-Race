...
function makefood()
{
    ...
    bb.pozy = Math.floor(Math.random() * (window.innerHeight/2-50-60)+60);
...
function spawndummy()
{
    ...
    dum[0].pozx=750;
    dum[0].pozy=550;
    dum[0].getdummy.style.left=750 + 'px';
    dum[0].getdummy.style.top=550 + 'px';
}
...
spawndummy();
spawnsun();
//var iddummy = setInterval(spawndummy,500);
...
document.addEventListener("visibilitychange", function() {
    ...
    {   
        //iddummy = setInterval(spawndummy,500);
